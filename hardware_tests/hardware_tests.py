"""
Modified PyCubedMini Library:

CircuitPython driver for PyCubed satellite board
PyCubed Mini mainboard-v02 for Pocketqube Mission

Updates:
FlatSat Hardware Tests: Neopixel, SDCard, Radio, IMU, Sun Sensors, Burn Wire IC
...
class Satellite:
    ...
    def __init__(self):
        ...
        self.hardware = {
                       ...
                       'Sun':    False,
                       'Coils':  False,
                       'BurnWire': False # initialize burnwire attribute to hardware dict
                       }
